...
public interface AudioRepository extends JpaRepository<Audio, Long> {
    ...
    List<Audio> findByUserIdAndDeletedFalse(Long userId);

    List<Audio> findByUserIdAndStatusAndDeletedFalse(Long userId, String aPublic);

    Optional<Audio> findByIdAndUserIdAndStatusAndDeletedFalse(Long id, Long uid, String published);

    Optional<Audio> findByIdAndUserIdAndStatusNotAndDeletedFalse(Long id, Long uid, String uploaded);
}
